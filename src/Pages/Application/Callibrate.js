                ...
                : index < 20 ?
                    ...
                    : index < 25 ?
                        (
                            <div className={classes.root}>
                                <Paper className={classes.greyPaper}>
                                    <CallibrateButton width={30} height={30} left={100} top={300}
                        ...
                        : index <= 30 ?
                            (
                                <div className={classes.root}>
                                    <Paper className={classes.greyPaper}>
                                        <CallibrateButton width={30} height={30} left={500} top={300}
                                                          onClick={ButtonClicked}/>
                                        <CallibrateTypography/>
                                    </Paper>
                                </div>
                            ...
                            : index <= 35 ?
                                (
                                    <div className={classes.root}>
                                        <Paper className={classes.greyPaper}>
                                            <CallibrateButton width={30} height={30} left={900} top={300}
                                                              onClick={ButtonClicked}/>
                                            <CallibrateTypography/>
                                        </Paper>
                                    </div>
                                ...
                                : index <= 40 ?
                                    (
                                        <div className={classes.root}>
                                            <Paper className={classes.greyPaper}>
                                                <CallibrateButton width={30} height={30} left={1300} top={300}
                                                                  onClick={ButtonClicked}/>
                                                <CallibrateTypography/>
                                            </Paper>
                                        </div>
                                    ...
                                    : index <= 45 ?
                                        (
                                            <div className={classes.root}>
                                                <Paper className={classes.greyPaper}>
                                                    <CallibrateButton width={30} height={30} left={100} top={500}
                                                                      onClick={ButtonClicked}/>
                                                    <CallibrateTypography/>
                                                </Paper>
                                            </div>
                                        ...
                                        : index <= 50 ?
                                            (
                                                <div className={classes.root}>
                                                    <Paper className={classes.greyPaper}>
                                                        <CallibrateButton width={30} height={30} left={500} top={500}
                                                                          onClick={ButtonClicked}/>
                                                        <CallibrateTypography/>
                                                    </Paper>
                                                </div>
                                            ...
                                            : index <= 55 ?
                                                (
                                                    <div className={classes.root}>
                                                        <Paper className={classes.greyPaper}>
                                                            <CallibrateButton width={30} height={30} left={900}
                                                                              top={500} onClick={ButtonClicked}/>
                                                            <CallibrateTypography/>
                                                        </Paper>
                                                    </div>
                                                )
                                                : index <= 60 ?
                                                    (
                                                        <div className={classes.root}>
                                                            <Paper className={classes.greyPaper}>
                                                                <CallibrateButton width={30} height={30} left={1300}
                                                                                  top={500} onClick={ButtonClicked}/>
                                                                <CallibrateTypography/>
                                                            </Paper>
                                                        </div>
                                                    ...
                                                    : index <= 65 ?
                                                        (
                                                            ...
                                                            (
                                                                <div className={classes.root}>
                                                                    <Paper className={classes.whitePaper}>
                                                                        <CallibrateButton width={30} height={30}
                                                                                          left={650} top={100}
                                                                                          onClick={ButtonClicked}/>
                                                                        <CallibrateTypography/>
                                                                    </Paper>
